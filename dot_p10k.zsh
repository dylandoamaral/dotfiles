# Generated by Powerlevel10k configuration wizard on 2021-10-10 at 11:49 CEST.
...
() {
  ...
  # Python prefix.
  typeset -g POWERLEVEL9K_VIRTUALENV_PREFIX='%fusing '
  # Custom icon.
  ...
  # AWS prefix.
  typeset -g POWERLEVEL9K_AWS_PREFIX='%ffor '
